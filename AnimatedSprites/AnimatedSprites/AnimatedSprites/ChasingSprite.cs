...
namespace AnimatedSprites
{
    class ChasingSprite : Sprite
    {
        ...
        SpriteManager spriteManager, int chasingSpritePointValue)
        : base(textureImage, position, frameSize, collisionOffset,
        currentFrame, sheetSize, speed, collisionCueName, chasingSpritePointValue)
        {
        ...
        string collisionCueName, SpriteManager spriteManager, int chasingSpritePointValue)
        : base(textureImage, position, frameSize, collisionOffset,
        currentFrame, sheetSize, speed, millisecondsPerFrame,
        collisionCueName, chasingSpritePointValue)
        {
            this.spriteManager = spriteManager;
        }
