...
namespace AnimatedSprites
{
    class EvadingSprite : Sprite
    {
        ...
        int evasionRange, int evadingSpritePointValue)
            : base(textureImage, position, frameSize, collisionOffset,
            currentFrame, sheetSize, speed, collisionCueName, evadingSpritePointValue)
        {
        ...
        float evasionSpeedModifier, int evasionRange, int evadingSpritePointValue)
            : base(textureImage, position, frameSize, collisionOffset,
            currentFrame, sheetSize, speed, millisecondsPerFrame,
            collisionCueName, evadingSpritePointValue)
        {
            this.spriteManager = spriteManager;
            this.evasionSpeedModifier = evasionSpeedModifier;
            this.evasionRange = evasionRange;
